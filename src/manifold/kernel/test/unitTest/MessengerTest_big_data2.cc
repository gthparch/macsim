...
//!
//! In this program, the Serialization function doesn't do anything,
//! data is mem-copied into kernel's buffer. This works if data type
//! contains no pointers and simulation is run on homogeneous machines.
//!
