...
enum ROUTING_SCHEME { TWONODE_ROUTING, XY_ROUTING, NEGATIVE_FIRST, ODD_EVEN, WEST_FIRST, NORTH_LAST, NORTH_LAST_NON_MINIMAL, TORUS_ROUTING, RING_ROUTING, RING_ROUTING_UNI };
