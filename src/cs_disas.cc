...
bool cs_disas::get_regs_access(cs_insn *insn, cs_regs regs_read, cs_regs regs_write, uint8_t *regs_read_count,
                               uint8_t *regs_write_count) {
  bool ret;

  ret = cs_regs_access(handle, insn, regs_read, regs_read_count, regs_write, regs_write_count);
