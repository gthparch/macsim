...
The Process Manager (explained in Chapter~\ref{sec:process_manager}) does
...
\TODO{max\_block\_per\_core\_super - are there no per application knobs?}.  For each
...
instructions from different warps in \TODO{round-robin order - not true!}.
