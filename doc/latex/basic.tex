...
\todo{will google code project not provide source?, Do we have a Wiki? Correct section title}
...
\todo{below command is incorrect, give command for anonymous checkout!}
\begin{Verbatim}
...
\begin{description}\firmlist
  ...
  \item[Compiler] Any compiler that supports the C++0x (or C++11)
    standard. \SIM has been verified to work with: \Verb+gcc+, \Verb+icc (TODO)+. \todo{versions?}
...
\todo{SST or \textit{sst-simulator}?}
