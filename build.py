...
def parse_arg():
  ...
  parser.add_option("--newpin", action="store_true", dest="pin_3_7_trace", default=False, help="trace based on pin 3.7 ")
...
#########################################################################################
def build_test():
  build_option = ['', 'debug=1', 'gprof=1', 'qsim=1', 'pin_3_7_trace=1']
