...
link_bus_memctrl_i.connect((macsim, "core0_icache", "50ps"), (memctrl_i, "highlink", "50ps"))
link_bus_memctrl_d = sst.Link("link_bus_memctrl_d")
link_bus_memctrl_d.connect((macsim, "core0_dcache", "50ps"), (memctrl_d, "highlink", "50ps"))
